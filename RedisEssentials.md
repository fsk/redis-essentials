...
### Request/Response Protocol ve Round Trip Time (RTT)
* Redis, client-server modelini kullanan ve Request/Response protokolü olarak adlandırılan bir TCP server'ıdır.
* Bu, genellikle bir isteğin aşağıdaki adımlarla tamamlandığı anlamına gelir:<br>
<b>-></b> Client, server'a bir sorgu gönderir ve genellikle engelleyici bir şekilde, server'ın yanıtını socket'ten okur.
<b>-></b> Server komutu işler ve yanıtı client'a geri gönderir.
...
* <b>ÖNEMLİ NOT:</b> Client pipelining kullanarak komutlar gönderirken, server yanıtları sıraya koymak zorunda kalacak 
